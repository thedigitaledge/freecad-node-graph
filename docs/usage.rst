...
3. A window will appear containing the Node Library, Node Canvas, and Properties Inspector.
...
Adding Nodes
~~~~~~~~~~~~
In the **Node Library** panel on the left side, double-click any node category to expand it, then double-click a node type (e.g. *Box*, *Cylinder*, *Fuse*) to place it on the canvas.
