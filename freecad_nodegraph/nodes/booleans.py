...
from freecad_nodegraph.nodes.primitives import MockShape, Part, HAS_FREECAD
...
class FuseNode(BaseNode):
    ...
    def compute(self) -> None:
        ...
        if shape_a is None:
            ...
            if Part and HAS_FREECAD and hasattr(shape_a, "fuse") and hasattr(shape_b, "fuse"):
...
class CutNode(BaseNode):
    ...
    def compute(self) -> None:
        ...
        if base_shape is None:
            ...
            if Part and HAS_FREECAD and hasattr(base_shape, "cut") and hasattr(tool_shape, "cut"):
...
class CommonNode(BaseNode):
    ...
    def compute(self) -> None:
        ...
        if shape_a is None or shape_b is None:
            ...
            if Part and HAS_FREECAD and hasattr(shape_a, "common") and hasattr(shape_b, "common"):
